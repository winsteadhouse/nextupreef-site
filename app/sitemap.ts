...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/blog/reef-tank-water-change-guide`, lastModified: new Date("2026-09-14"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/blog/two-part-vs-all-in-one-vs-kalkwasser`, lastModified: new Date("2026-09-14"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/blog/coralvue-hydros-vs-neptune-apex`, lastModified: new Date("2026-09-14"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/blog/reef-score-stability-score-explained`, lastModified: new Date("2026-09-14"), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${baseUrl}/blog/how-to-connect-apex`,                          lastModified: new Date("2026-09-14"), changeFrequency: "monthly", priority: 0.95 },
