      ...
      <section style={{ padding: "40px 20px 60px", maxWidth: "1100px", margin: "0 auto" }}>
        ...
        >
          {[
            ...
            {
              icon: "⚡",
              title: "Add Shelly outlets",
              body: "Use inexpensive Shelly Wi-Fi outlets for dosing pumps, heaters, skimmers, and lights — controlled from one app.",
            },
            {
              icon: "☁️",
      ...
      <section style={{ padding: "40px 20px 80px", maxWidth: "900px", margin: "0 auto" }}>
        ...
        >
          {[
            ...
            { label: "Smart outlets", hub: "Shelly (~$15 each)", apex: "EnergyBar 832 (~$220)" },
