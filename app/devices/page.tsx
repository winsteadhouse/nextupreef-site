...
const integrations = [
  ...
  },
  {
    ...
    pros: ['Uses the Apex you already own', 'Probe and Trident readings go straight into your logs', 'Outlets, Feed Mode, heater temps and dosing in one app', 'Schedules are saved to the Apex and run 24/7', 'Reach it from anywhere with a Tank Hub'],
    cons: ['Without a Tank Hub, your phone must be on the same WiFi as the Apex', 'Dosing uses a regular outlet and pump (DOS/DDR not supported yet)'],
  ...
  },
  {
    ...
    pros: ['Low cost and quick to add', 'Schedules run on the plug, even offline', 'Each dose confirmed by power draw', 'Missed-dose alerts', 'Add a Shelly Pill and probe for real water temperature', 'Switch plugs from anywhere with a Tank Hub'],
    cons: ['Outlet control only, no water probes', 'Without a Tank Hub, phone and plug need the same WiFi'],
