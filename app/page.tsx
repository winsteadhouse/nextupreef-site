    ...
    <main style={{ background: "var(--bg-dark)" }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          {[
            { src: "/screenshots/store-log-v3.png", label: "Log", alt: "Log parameters in seconds with real-time color feedback" },
            { src: "/screenshots/store-dashboard-v4.png", label: "Dashboard", alt: "Reef Score and Stability Score dashboard", featured: true },
            { src: "/screenshots/store-community-v2.png", label: "Community", alt: "Reef community leaderboard" },
          ].map(s => (
        ...
        <div style={{
          ...
          {[
            { src: "/screenshots/store-reminders-v3.png", label: "Reminders", alt: "Smart maintenance reminders" },
            { src: "/screenshots/store-analytics-v3.png", label: "Analytics", alt: "Parameter trend charts" },
            { src: "/screenshots/store-tank-v4.png", label: "Tank", alt: "Full tank profile with equipment and livestock" },
          ].map(s => (
