      ...
      <article style={{ maxWidth: "760px", margin: "0 auto", padding: "80px 20px" }}>
        ...
        <div style={{ background: "linear-gradient(135deg, rgba(14,165,233,0.15), rgba(44,196,214,0.1))",
          ...
          <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap", marginBottom: "20px" }}>
            <a href="https://amzn.to/4dLhHOO" target="_blank" rel="noopener noreferrer sponsored"
              style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "12px 24px",
                borderRadius: "10px", background: "var(--reef)", color: "white",
