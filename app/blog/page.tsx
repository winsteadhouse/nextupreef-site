...
const appGuides: Post[] = [
  ...
  { slug: "reef-tank-automation-without-a-controller", title: "Automate a Reef Tank Without a Controller", description: "Three smart plugs, a temperature probe and the pumps you own - lighting, dosing, temperature and flow for about $90.", date: "September 21, 2026", readTime: "9 min", tag: "Budget Build", image: "/screenshots/site-v3/phones-dosing.png" },
