...
{    category: 'Account & Privacy',
  ...
  {    category: 'Pro & Subscription', q: 'What does Pro include?', a: 'Pro includes: Reef AI Advisor & Chat, AI Photo Parameter Logging, Tank Journal with photos, full historical analytics (6M, 1Y, All), Neptune Apex integration, Shelly smart outlet control, automated dosing and lighting, unlimited reminders, and multiple tanks.' },
  ...
  { category: "Devices & Hardware", q: "What hardware works with NextUpReef?", a: "NextUpReef supports Shelly Plug US Gen4 smart outlets and Neptune Apex controllers today. Shelly outlets automate dosing, lighting, heaters, skimmers, and return pumps directly from the app. The NextUpReef Hub is coming soon. See nextupreef.com/devices for the full list." },
  { category: "Devices & Hardware", q: "What is a Shelly outlet and how does it work?", a: "Shelly Plug US Gen4 is a Wi-Fi smart outlet available on Amazon for $24.99. Add it in NextUpReef, tag it as a doser, heater, light, skimmer, or return pump, and control it from the app. Schedules are saved to the outlet -- dosing and lighting run 24/7 even if your phone is off or internet is down. No Shelly app needed." },
  { category: "Devices & Hardware", q: "Do I need a hub or special equipment to use Shelly outlets?", a: "No. Shelly outlets connect directly to your home Wi-Fi. NextUpReef talks to them over your local network -- no cloud relay needed. Once a schedule is saved to the outlet, it runs completely on its own." },
  { category: "Devices & Hardware", q: "Can I automate my dosing with NextUpReef?", a: "Yes. Plug your dosing pump into a Shelly outlet, calibrate it once in the app, set your daily mL target, and NextUpReef writes the schedule to the outlet. It doses automatically every day. Full guide at nextupreef.com/blog/how-to-setup-dosing-shelly." },
  { category: "Devices & Hardware", q: "Can I automate my lights with NextUpReef?", a: "Yes. Link a Shelly outlet to a light fixture and set an on/off schedule with ramp times. NextUpReef pushes the schedule to the outlet. Shelly handles the on/off and timer side." },
  { category: "Devices & Hardware", q: "What is the Shelly Flood Sensor?", a: "The Shelly Flood Sensor Gen4 ($39.99) is a Wi-Fi leak detector. Place it under your sump or ATO and it alerts you if water is detected. It also has a temperature sensor. Full NextUpReef integration is coming soon." },
  { category: "Devices & Hardware", q: "Where can I buy compatible hardware?", a: "Visit nextupreef.com/devices for the full list with Amazon purchase links. Shelly outlets and flood sensors are available now. The NextUpReef Hub will be sold directly by us at launch." },
  { category: "NextUpReef Hub", q: "What is the NextUpReef Hub?", a: "The NextUpReef Hub is our own dedicated reef controller that stays connected 24/7. It will support pH and temperature probe inputs, Shelly outlet control, leak sensor support, and deep app integration. Coming soon -- join the waitlist at nextupreef.com/hub." },
  { category: "NextUpReef Hub", q: "How is the Hub different from Shelly outlets?", a: "Shelly outlets are third-party smart plugs that work great for control and dosing today. The Hub will be our own hardware with dedicated probe inputs and deeper integration. Shelly is the smart power layer -- the Hub adds monitoring and intelligence on top." },
  { category: "NextUpReef Hub", q: "How is the Hub different from a Neptune Apex?", a: "The Apex starts at $319 with a large professional ecosystem. The NextUpReef Hub will be a more affordable, app-first alternative with AI Advisor, Reef Scores, and community built in. See the comparison at nextupreef.com/blog/nextupreef-hub-vs-neptune-apex." },
  { category: "NextUpReef Hub", q: "When will the Hub be available?", a: "We are targeting a 2025/2026 launch starting from $179. Join the waitlist at nextupreef.com/hub to be notified first and get early access pricing." },
  { category: "NextUpReef Hub", q: "Do I need the Hub to use NextUpReef?", a: "No. NextUpReef works great without any hardware. The Hub is an optional upgrade for users who want a dedicated always-on controller." },
];
