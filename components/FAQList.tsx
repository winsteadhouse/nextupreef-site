...
{    category: 'Account & Privacy',
  ...
  { category: "Devices & Hardware", q: "What hardware works with NextUpReef?", a: "NextUpReef supports Shelly Plug US Gen4 smart outlets and Neptune Apex controllers today. Shelly outlets automate dosing, lighting, heaters, skimmers, and return pumps directly from the app. See nextupreef.com/devices for the full list." },
  ...
  { category: "Devices & Hardware", q: "Where can I buy compatible hardware?", a: "Visit nextupreef.com/devices for the full list with Amazon purchase links. Shelly outlets and flood sensors are available now." },
];
